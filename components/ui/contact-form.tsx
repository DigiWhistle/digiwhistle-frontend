...
const FormSchema = z.object({
  ...
  termsCheck: z.literal(true),
});

function ContactForm({ userType }: { userType: "influencer" | "brand" }) {
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="w-full space-y-6 ">
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <FormTextInput
            formName="name"
            label={userType === "influencer" ? "Full Name" : "Brand Name"}
        ...
        <FormTextInput
          ...
          label={userType === "influencer" ? "Profile Link" : "Website Link"}
